 ...
 */
public class GovExVsHealthEx implements ComputeAnalysis{
	/**
	...
	public void computeAnalysis(UserRequest request) {
		...
		Data analysisTwo = new FetchData(request, "SH.XPD.CHEX.GD.ZS").getData();
		...
		model.setAnalysisType("Ratio of Government expenditure on education vs Current health expenditure");
		...
		model.setSeries1("Government expenditure  total (% of GDP) ");
		model.setSeries2("Current health expenditure (% of GDP)");
