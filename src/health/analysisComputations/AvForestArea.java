 ...
 */
public class AvForestArea implements ComputeAnalysis{
	...
	public void computeAnalysis(UserRequest request) {
		...
		Data analysisOne = new FetchData(request, "AG.LND.FRST.ZS").getData();
		...
		model.setAnalysisType("Average Forest Area");
		...
		model.setSeries1("Average Forest area (% of land area)");
